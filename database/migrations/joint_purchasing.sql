...
-- Дата скрипта: 19.03.2015 22:48:10
...
CREATE TABLE purchases (
  id INT(11) NOT NULL AUTO_INCREMENT,
  user_id INT(11) NOT NULL,
  pricing_grid_column_id INT(11) NOT NULL DEFAULT 1,
...
(3, 8, 'image', 'a0668432c70fcfec9c87452b935ee70e.jpg', 1),
(4, 9, 'image', 'a177b94a7d332017b2b01206baba8322.jpg', 1),
(5, 10, 'image', 'bd8a53f376f9e2f65d6010d426dc1380.jpg', 1),
(6, 11, 'image', 'd29af9b93b4ff4c5a7517f409a111efc.jpg', 1),
(11, 9, 'image', 'd969e7c66e22e6ec0cb21ac1477ea1a2.jpg', 1);
...
(11, 'Пенка-краска для волос', 'Использование пенки для окрашивания волос превратит процесс окраски в настоящее удовольствие. Пенная текстура позволит сделать процесс окрашивания столь же легким, как и обычное мытье волос. При этом новинка надолго сохраняет интенсивность цвета, до 100% закрашивает седину и дарит волосам силу и здоровый блеск.', 1, '2015-03-12 21:45:07', '2015-03-15 17:11:39'),
(12, 'Мист ухаживающий для волос', 'Освежающий спрей Angel’s Ring Aqua Hair Mist Holika Holika делает волосы послушными и эластичными. Подходит для использования и зимой (предотвращает образование статического электричества на волосах, освежает укладку), и летом (увлажняет, предотвращает ломкость). Очень легкий, не утяжеляет волосы. Применение: небольшое количество спрея распылите на волосы по всей длине с расстояния примерно 15-20 см. Расчешите волосы.', 1, '2015-03-15 16:55:38', '2015-03-15 17:11:32');

-- 
-- Вывод данных для таблицы products_in_purchase
--
INSERT INTO products_in_purchase VALUES
(1, 1, 8, 'Какой то продукт', 0.00, '2015-03-18 12:05:02', '0000-00-00 00:00:00');
...
(1, 1, 1, '2015-03-05 04:29:39', '56', 'первая закупка', '2015-02-26 04:30:03', '2015-02-26 04:30:03'),
(2, 1, 1, '2015-03-05 04:30:03', '3456346', 'новая закупка', '2015-02-26 04:33:41', '2015-02-26 04:33:41'),
(3, 1, 1, '2015-03-05 04:33:58', 'ert', 'уфа', '2015-02-26 04:34:02', '2015-02-26 04:34:02'),
(4, 1, 1, '2015-03-05 04:34:03', 'sdfg', 'вамви', '2015-02-26 04:34:22', '2015-02-26 04:34:22'),
(11, 0, 1, '0000-00-00 00:00:00', 'Простая закупка', 'Простая закупка, можно покупать дешево', '2015-03-19 19:43:45', '2015-03-19 19:43:45');
