...
-- Дата скрипта: 10.03.2015 18:22:13
...
(1, 0, 1, 18, 'Каталог товаров'),
(2, 1, 2, 9, 'Парфюмерия'),
(3, 1, 10, 13, 'Новый элемент'),
(6, 2, 3, 8, 'Шампунь'),
(7, 6, 4, 5, 'Шампунь для детей'),
(8, 6, 6, 7, 'Шампунь для жирных волос'),
(9, 3, 11, 12, 'Программки 2015');
